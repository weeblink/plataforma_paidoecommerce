...
export function CreateMentoringGroupModal({ mentoringId, onCreate }: Props) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const formatedValues = {
        ...
        mentorship_id: mentoringId,
      }

      await api.post(`/mentoring/group-management`, formatedValues)

      toast.success('Grupo de mentoria criado com sucesso')
      onCreate()
      setOpen(false)
    } catch (error) {
      let errorMessage = 'Ocorreu um erro ao criar o grupo de mentoria'
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="font-poppins">
            Criar grupo de mentoria
          </DialogTitle>
          <DialogDescription>
            Preencha os campos abaixo para criar um novo grupo de mentoria
          </DialogDescription>
        </DialogHeader>
