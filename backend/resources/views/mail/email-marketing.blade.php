        ...
        <td class="container">
            <div class="content">
                <div class="text-center" style="margin-bottom: 25px">
                    <img style="width: 250px" src="{{  preg_replace('/^http:/', 'https:', URL::route('api.email_marketing.set_opened', [ $data['email_id'], $data['lead_id'] ]) ) }}">
                </div>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                            <tr>
                                                                <td> <a href="{{ $data['type_action'] === "link" ? $data['link'] : $data[ 'file_url' ] }}" target="_blank">Conferir agora!</a> </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
